...
function RenderPartner(props) {
    //This console was to help me find the props order of things. 
    //console.log("Render Partner", props.partner.description);
    if(props.partner) {
        return (
            <React.Fragment>
                <Media object src={props.partner.image} alt={props.partner.name} width="150" />
                <Media body className="ml-5 mb-4">
                    <Media heading> {props.partner.name} </Media> {props.partner.description}
                </Media>
            </React.Fragment>
        );
    };
